...
Public Sub CreateWindow_Register()
    ...
    ' Textos
    CreateLabel WindowCount, "lblUsername", 15, (WindowTopBar + 14) - 4, 242, , "Usuário", Fonts.Default, White, Alignment.AlignCentre
...
Public Sub CreateWindow_Dialogue()
    ...
    CreateButton WindowCount, "btnNo", 196, WindowTopBar + 87, 177, 30, "Não", Default, , , False, , , , , DesignTypes.DesignRedNormal, DesignTypes.DesignRedHover, DesignTypes.DesignRedClick, , , GetAddress(AddressOf Dialogue_No)
