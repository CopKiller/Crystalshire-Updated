            ...
            Case ITEM_TYPE_KEY
                ...
                Select Case GetPlayerDir(PlayerIndex)
                    Case DIR_UP
                        ...
                        If GetPlayerY(PlayerIndex) > 0 Then
                            x = GetPlayerX(PlayerIndex)
                            y = GetPlayerY(PlayerIndex) - 1
                        Else
                            Exit Sub
                        End If
                    ...
                    Case DIR_DOWN
                        ...
                        If GetPlayerY(PlayerIndex) < Map(GetPlayerMap(PlayerIndex)).MapData.MaxY Then
                            x = GetPlayerX(PlayerIndex)
                            y = GetPlayerY(PlayerIndex) + 1
                        Else
                            Exit Sub
                    ...
                    Case DIR_LEFT, DIR_UP_LEFT, DIR_DOWN_LEFT
                        ...
                        If GetPlayerX(PlayerIndex) > 0 Then
                            x = GetPlayerX(PlayerIndex) - 1
                            y = GetPlayerY(PlayerIndex)
                        Else
                            Exit Sub
                        End If
                    ...
                    Case DIR_RIGHT, DIR_UP_RIGHT, DIR_DOWN_RIGHT
                        ...
                        If GetPlayerX(PlayerIndex) < Map(GetPlayerMap(PlayerIndex)).MapData.MaxX Then
                            x = GetPlayerX(PlayerIndex) + 1
                            y = GetPlayerY(PlayerIndex)
                        Else
                            Exit Sub
